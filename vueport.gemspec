...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Single file components for Rails with Vue JS and Webpack}
  spec.description   = %q{Use webpack and Vue js to get modern front end technology in your Rails app, including hotloading and single file components.}
